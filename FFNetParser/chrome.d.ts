...
declare module chrome.bookmarks {
    ...
    interface BookmarkRemovedEvent extends chrome.events.Event {
        addListener(
            callback: (id: string, removeInfo: BookmarkRemoveInfo) => void
        ): void;
    }
    ...
    interface BookmarkMovedEvent extends chrome.events.Event {
        addListener(
            callback: (id: string, moveInfo: BookmarkMoveInfo) => void
        ): void;
    }
    ...
    interface BookmarkChangedEvent extends chrome.events.Event {
        addListener(
            callback: (id: string, changeInfo: BookmarkChangeInfo) => void
        ): void;
    }
    ...
    interface BookmarkChildrenReordered extends chrome.events.Event {
        addListener(
            callback: (id: string, reorderInfo: BookmarkReorderInfo) => void
        ): void;
    }
...
declare module chrome.devtools.inspectedWindow {
    ...
    interface ResourceContentCommittedEvent extends chrome.events.Event {
        addListener(
            callback: (resource: Resource, content: string) => void
        ): void;
    }
    ...
    export function eval(
        expression: string,
        callback?: (result: Object, isException: boolean) => void
    ): void;
...
declare module chrome.devtools.panels {
    ...
    interface PanelSearchEvent extends chrome.events.Event {
        addListener(
            callback: (action: string, queryString?: string) => void
        ): void;
    }
...
declare module chrome.input.ime {
    ...
    interface KeyEventEvent extends chrome.events.Event {
        addListener(
            callback: (engineID: string, keyData: KeyboardEvent) => void
        ): void;
    }
    ...
    export function setCandidateWindowProperties(
        parameters: CandidateWindowPropertiesParameters,
        callback?: (success: boolean) => void
    ): void;
...
declare module chrome.types {
    ...
    interface ChromeSettingChangedEvent extends chrome.events.Event {
        addListener(
            callback: (details: ChromeSettingGetResultDetails) => void
        ): void;
    }
    ...
    interface ChromeSetting {
        ...
        get(
            ...
            callback?: ChromeSettingGetResultDetails
        ): void;
...
declare module chrome.webNavigation {
    ...
    interface WebNavigationReferenceFragmentUpdatedEvent
        ...
        addListener(
            callback: (details: ReferenceFragmentUpdatedDetails) => void
        ): void;
    }
    ...
    interface WebNavigationHistoryStateUpdatedEvent
        extends chrome.events.Event {
        addListener(
            callback: (details: HistoryStateUpdatedDetails) => void
        ): void;
    }

    interface WebNavigationCreatedNavigationTargetEvent
        extends chrome.events.Event {
        addListener(
            callback: (details: CreatedNavigationTargetDetails) => void
        ): void;
    }
    ...
    export function getFrame(
        ...
        callback: (details?: GetFrameResultDetails) => void
    ): void;
...
declare module chrome.webRequest {
    ...
    interface WebRequestBeforeRedirectEvent extends chrome.events.Event {
        addListener(
            callback: (details: OnBeforeRedirectDetails) => void,
            filter?: RequestFilter,
            opt_extraInfoSpec?: string[]
        ): void;
    }
    ...
    interface WebRequestBeforeSendHeadersEvent extends chrome.events.Event {
        addListener(
            callback: (details: OnBeforeSendHeadersDetails) => void,
            filter?: RequestFilter,
            opt_extraInfoSpec?: string[]
        ): void;
    }
    ...
    interface WebRequestSendHeadersEvent extends chrome.events.Event {
        addListener(
            callback: (details: OnSendHeadersDetails) => void,
            filter?: RequestFilter,
            opt_extraInfoSpec?: string[]
        ): void;
    }
    ...
    interface WebRequestBeforeRequestEvent extends chrome.events.Event {
        addListener(
            callback: (details: OnBeforeRequestDetails) => void,
            filter?: RequestFilter,
            opt_extraInfoSpec?: string[]
        ): void;
    }
