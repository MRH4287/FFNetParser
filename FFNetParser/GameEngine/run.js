var container = $('<div></div>')
    ...
    .attr(
        'title',
        'Thank you for using my Script! Have a nice day! - © 2015 Pokémon. © 1995–2015 Nintendo/Creatures Inc./GAME FREAK inc. Pokémon, Pokémon character names, Nintendo 3DS, Nintendo DS, Wii, and Wiiware are trademarks of Nintendo.'
    )
    .appendTo($('body'));
...
var gameHandler = new GameHandler({
    ...
    playerModel: 'pichu',
    basePath:
        'https://www.mrh-development.de/FanFictionUserScript/SSLProxy/?url=',
});
