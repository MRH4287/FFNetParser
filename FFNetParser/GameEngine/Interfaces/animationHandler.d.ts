...
declare class AnimationHandler {
    ...
    public clear(): void;
    public setPosition(elementName: string, x: number, y: number, rerender?: boolean): void;
    ...
    public drawColorRect(name: string, x: number, y: number, width: number, height: number, red: number, green: number, blue: number, opacity?: number, rerender?: boolean): void;
    public writeText(name: string, text: string, x: number, y: number, font?: string, textBaseline?: string, textAlign?: string, fillStyle?: string, maxWidth?: number, rerender?: boolean): void;
    public drawRect(name: string, x: number, y: number, width: number, height: number, fillStyle?: string, rerender?: boolean): void;
    public removeGenericDraw(name: string): void;
    private getNewAnimationInstance(input);
    public playAnimation(elementID: string, animation: string, group?: string): void;
    ...
    private drawImage(name, offsetX, offsetY, width?, height?, canvasOffsetX?, canvasOffsetY?, canvasImageWidth?, canvasImageHeight?);
    public test(): void;
}
