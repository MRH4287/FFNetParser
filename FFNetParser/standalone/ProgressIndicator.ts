...
class ProgressIndicator {
    ...
    private initEventMessageMap() {
        ...
        this.eventMessageMap['standalonePreRequestCategories'] =
            'Requesting Categories';
        this.eventMessageMap['standalonePostCategoriesRequest'] =
            'Got Categories';
        this.eventMessageMap['standaloneCategoriesParsed'] =
            'Categories parsed successfully';
        this.eventMessageMap['standalonePreRequestElements'] =
            'Requesting Elements';
        this.eventMessageMap['standalonePostRequestElements'] = 'Got Elements';
        this.eventMessageMap['standaloneElementsParsed'] =
            'Elements parsed successfully';
    }
    ...
    private initGUI() {
        ...
        container.append(
            '<div class="col-md-12">Status: <b class="messageContainer">' +
                this.lastMessage +
                '</b></div>'
        );
