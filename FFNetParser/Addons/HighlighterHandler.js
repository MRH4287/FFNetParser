...
var HighlighterHandler = (function (_super) {
    __extends(HighlighterHandler, _super);
    function HighlighterHandler(parser) {
        var _this = _super.call(this, parser) || this;
        var self = _this;
        if (!_this.Config.disable_highlighter) {
            self.EventHandler.AddEventListener(Events.PostElementParse, function (s, data) {
                self.UpdateElement(data);
            });
            self.EventHandler.AddEventListener(Events.OnLoad, function () {
                self.EnableInStoryHighlighter();
            });
        }
        return _this;
    }
    HighlighterHandler.prototype.UpdateElement = function (data) {
        var self = this;
     ...
     */
    HighlighterHandler.prototype.HighlighterCallback = function (config, data) {
        var self = this;
        var element = data.Element;
        if (self.DEBUG) {
   ...
   */
    HighlighterHandler.prototype.EnableInStoryHighlighter = function () {
        if (this.DEBUG) {
        ...
        var info = self.EventHandler.RequestResponse(Events.RequestGetStoryInfo, self, storyInfoRequest);
...
//# sourceMappingURL=HighlighterHandler.js.map