...
var GUIHandler = (function (_super) {
    __extends(GUIHandler, _super);
    function GUIHandler(parser) {
        var _this = _super.call(this, parser) || this;
        /**
         *  The Main Container for the Bootsrap Modal
         */
        _this._bootstrapContainer = null;
        /**
         * The Container for the GUI
         */
        _this._guiContainer = null;
        /**
        ...
        _this._categories = {};
        var self = _this;
        _this.EventHandler.AddEventListener(Events.ActionGuiShowMenu, function () {
            self.Gui();
        });
        _this.EventHandler.AddEventListener(Events.ActionGuiShowMessageMenu, function () {
            self.MessagesGUI();
        });
        _this.EventHandler.AddEventListener(Events.ActionGuiShowFeedbackMenu, function () {
            self.FeedbackGUI();
        });
        _this.EventHandler.AddEventListener(Events.ActionGuiToggleLiveChat, function () {
            self.ToggleLiveChat();
        });
        _this.EventHandler.AddEventListener(Events.ActionGuiShowStoryPrefabList, function (s, args) {
            self.ShowStoryPrefabList(args);
        });
        return _this;
    }
    GUIHandler.prototype.RegisterGUI = function (name, collection, elements, sticky, customSave) {
    ...
    GUIHandler.prototype.RegisterCategory = function (data) {
    ...
    GUIHandler.prototype.RenderGUI = function (element, target, size) {
    ...
    GUIHandler.prototype.RenderGUIElement = function (name, target, size) {
        if (size === void 0) { size = 6; }
        if (typeof (this._guiData[name]) === "undefined") {
    ...
    GUIHandler.prototype.SaveData = function (data) {
        var self = this;
    ...
    GUIHandler.prototype.SaveDataElement = function (name) {
        if (typeof (this._guiData[name]) === "undefined") {
            this.Log("No GUI with found with the name: ", name);
            return;
        }
    ...
    GUIHandler.prototype.SaveAll = function () {
        var self = this;
    ...
    GUIHandler.prototype.InitGUI = function () {
        this._guiData = {};
        this._categories = {};
        var self = this;
        var sortFunctions = [];
        $.each(this.Parser.SortMap, function (index, element) {
            sortFunctions.push({
                id: index,
                name: element.Name
            });
    ...
    */
    GUIHandler.prototype.CreateElements = function (parent, elements, saveTo, size) {
        if (size === void 0) { size = 6; }
        var self = this;
     ...
     */
    GUIHandler.ShowModal = function (modal) {
     ...
     */
    GUIHandler.CreateBootstrapModal = function (content, title, buttons) {
    ...
    */
    GUIHandler.prototype.GuiCreate = function () {
        var _this = this;
        ...
        $(".ffnetModal").remove();
        var buttons = [];
        buttons.push($('<button type="button" class="btn btn-default">Config Import / Export</button>').click(function (e) {
            if (confirm(_this._("All unsaved changes will be deleted!"))) {
                _this.OpenSaveConfig();
            }
        }));
        buttons.push($('<button type="button" class="btn btn-primary">Menu</button>').click(function (e) {
            // Reopen:
            if (confirm(_this._("All unsaved changes will be deleted!"))) {
                _this.Hide();
                _this.Gui();
        ...
        buttons.push($('<button type="button" class="btn btn-danger">Reset Config</button>').click(function (e) {
            if (confirm(_this._('Are you sure to overwrite the Config? This will overwrite all your changes!'))) {
                _this.Hide();
                _this._guiData = {};
                _this._categories = {};
                _this._addCount = 0;
                _this.InitGUI();
                _this.Parser.DefaultConfig();
            }
        }));
        buttons.push($('<button type="button" class="btn btn-default">Support Me</button>').click(function (e) {
            if (confirm(_this._('If you want to support my work, you can do that on Patreon. Open Patreon page?'))) {
    ...
    // ---- GUI Helpers 
    // Buttons
    GUIHandler.prototype.GetSaveButtonContainer = function () {
    ...
    // Button Logic:
    GUIHandler.prototype.ButtonLogic = function () {
    ...
    ;
    GUIHandler.prototype.BackLogic = function () {
    ...
    ;
    // Render SubLogic:
    GUIHandler.prototype.GetButton = function (name, target, container) {
    ...
    ;
    GUIHandler.prototype.GetCategory = function (name, id, container) {
     ...
     */
    GUIHandler.prototype.Update = function () {
        var self = this;
        this.Log("Update GUI");
     ...
     */
    GUIHandler.prototype.AddForm = function (name, marker, mainContainer, displayBig) {
        if (displayBig === void 0) { displayBig = false; }
        ...
        var foundCount = 0;
        $.each(this.Parser.FoundElemementList, function (page, data) {
     ...
     *   Hides the GUI
     */
    GUIHandler.prototype.Hide = function () {
     ...
     *   Displays the GUI
     */
    GUIHandler.prototype.Show = function (closeCallback) {
     ...
     */
    GUIHandler.prototype.Gui = function () {
        this.InitGUI();
     ...
     */
    GUIHandler.prototype.OpenSaveConfig = function () {
     ...
     */
    GUIHandler.prototype.ToggleStoryConfig = function (storyInfo, managePresets) {
        //TODO: FIX ME
        if (managePresets === void 0) { managePresets = false; }
        //var self = this;
        //if (this._guiContainer == null)
        //{
        //    if (this.DEBUG)
     ...
     *   @param storyInfo Infos about the story
     */
    GUIHandler.prototype.ShowStoryPrefabList = function (storyInfo) {
        //TODO: Fix me!
        //var self = this;
     ...
     *   @param displayBig Don't minimize Element after adding
     */
    GUIHandler.prototype.AddHighlighterForm = function (name, config, mainContainer, custom, displayBig) {
        var _this = this;
        if (displayBig === void 0) { displayBig = false; }
        var self = this;
        ...
        this.RegisterGUI(name, function () {
            if (!custom) {
                if (typeof (_this.Config.highlighterPrefabs[name]) === "undefined") {
                    return {};
                }
                else {
                    return _this.Config.highlighterPrefabs[name];
                }
            }
            else {
                if (typeof (_this.Config.highlighter[name].custom) === "undefined") {
                    return {};
                }
                else {
                    return _this.Config.highlighter[name].custom;
                }
            }
        }, [
            {
            ...
            if (!custom && typeof (_this.Config.highlighterPrefabs[data.name]) !== "undefined") {
                delete _this.Config.highlighterPrefabs[data.name];
            }
            var name = data.instances['name'].val();
            if (name === "") {
                return;
            ...
            if (!custom) {
                _this.Config.highlighterPrefabs[name] = config;
            }
            else {
                if (typeof (_this.Config.highlighter[name]) === "undefined") {
                    _this.Config.highlighter[name] = {
                        custom: null,
                        hide: null,
                        image: null,
                        prefab: null
                ...
                _this.Config.highlighter[name].custom = config;
            }
        });
     ...
     */
    GUIHandler.prototype.ToggleLiveChat = function () {
        //TODO: Fix me!
        //var self = this;
        //if (this._guiContainer == null)
        //{
     ...
     */
    GUIHandler.prototype.MessagesGUI = function () {
     ...
     */
    GUIHandler.prototype.FeedbackGUI = function () {
        var self = this;
