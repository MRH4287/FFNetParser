...
var FFNetGuiHandler = (function (_super) {
    __extends(FFNetGuiHandler, _super);
    function FFNetGuiHandler(parser) {
    ...
    */
    FFNetGuiHandler.prototype.UpdateGUI = function () {
     ...
     */
    FFNetGuiHandler.GetStoryInfo = function (link) {
     ...
     */
    FFNetGuiHandler.prototype.GetUrlFromButton = function (button) {
    ...
    */
    FFNetGuiHandler.prototype.UpdateListColor = function (sender, args) {
        var odd = false;
        var self = this;
    ...
    FFNetGuiHandler.prototype.GetLinkToPageNumber = function (page) {
    ...
    FFNetGuiHandler.prototype.GetCurrentPage = function () {
